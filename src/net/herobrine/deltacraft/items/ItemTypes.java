...
public enum ItemTypes {
    ...
    TANK_BOOTS(ChatColor.RED + "Tank Boots", new String[] {}, null, Material.LEATHER_BOOTS, 0, 100, 100, 0,0,
            new ItemAbilities[] {}, true, Color.GRAY, true, false, null),
    ARCHER_HELMET(ChatColor.LIGHT_PURPLE + "Archer Helmet", new String[] {}, null, Material.LEATHER_HELMET, 0, 60, 30, 0,1,
            new ItemAbilities[] {}, true, Color.RED, true, false, null),
    ARCHER_CHESTPLATE(ChatColor.LIGHT_PURPLE + "Archer Chestplate", new String[] {}, null, Material.LEATHER_CHESTPLATE, 0, 130, 75, 0,2,
            new ItemAbilities[] {}, true, Color.RED, true, false,  null),
    ARCHER_LEGGINGS(ChatColor.LIGHT_PURPLE + "Archer Leggings", new String[] {}, null, Material.LEATHER_LEGGINGS, 0, 85, 50, 0,2,
            new ItemAbilities[] {}, true, Color.RED , true, false, null),
    ARCHER_BOOTS(ChatColor.LIGHT_PURPLE + "Archer Boots", new String[] {}, null, Material.LEATHER_BOOTS, 0, 30, 25, 0,1,
            new ItemAbilities[] {}, true, Color.RED, true, false, null),

    MAGE_HELMET(ChatColor.BLUE + "Mage Helmet", new String[] {}, null, Material.LEATHER_HELMET, 0, 75, 30, 75,0,
            new ItemAbilities[] {}, true, Color.BLUE, true, false, null),
    MAGE_CHESTPLATE(ChatColor.BLUE + "Mage Chestplate", new String[] {}, null, Material.LEATHER_CHESTPLATE, 0, 125, 50, 150,0,
            new ItemAbilities[] {}, true, Color.BLUE, true, false,  null),
    MAGE_LEGGINGS(ChatColor.BLUE + "Mage Leggings", new String[] {}, null, Material.LEATHER_LEGGINGS, 0, 100, 40, 100,0,
            new ItemAbilities[] {}, true, Color.BLUE, true, false, null),
    MAGE_BOOTS(ChatColor.BLUE + "Mage Boots", new String[] {}, null, Material.LEATHER_BOOTS, 0, 50, 15, 50,0,
            new ItemAbilities[] {}, true, Color.BLUE, true, false, null),

    HEALER_HELMET(ChatColor.GOLD + "Healer Helmet", new String[] {}, null, Material.LEATHER_HELMET, 0, 80, 50, 38,0,
            new ItemAbilities[] {}, true, Color.YELLOW, true, false, null),
    HEALER_CHESTPLATE(ChatColor.GOLD + "Healer Chestplate", new String[] {}, null, Material.LEATHER_CHESTPLATE, 0, 135, 75, 75,0,
            new ItemAbilities[] {}, true, Color.YELLOW, true, false,  null),
    HEALER_LEGGINGS(ChatColor.GOLD + "Healer Leggings", new String[] {}, null, Material.LEATHER_LEGGINGS, 0, 115, 60, 50,0,
            new ItemAbilities[] {}, true, Color.YELLOW, true, false, null),
    HEALER_BOOTS(ChatColor.GOLD + "Healer Boots", new String[] {}, null, Material.LEATHER_BOOTS, 0, 65, 30, 25,0,
            new ItemAbilities[] {}, true, Color.YELLOW, true, false, null),
